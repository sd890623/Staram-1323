...
$page_title = __('社区', 'cactusthemes'); //overwrite page title
                    ...
                    <div id="content" class="<?php echo $layout!='full'?'col-md-9':'col-md-12' ?><?php echo ($layout == 'left') ? " revert-layout":"";?>">
                        ...
                        <div class="project-listing">
                            ...
                            <div class="filter-cat">
                                ...
                                include(TEMPLATEPATH.'/js/myJS.php');
                                ...
                                foreach ($pro_cat as $p_term) {
                                    ...
                                    echo '<a class="btn btn-lighter" '.$bg_cr2.'>'.$p_term->name.'</a> ';
                            ...
                            while ( have_posts() ) : the_post(); ?>
                                                     ...
                                                     <?php echo '<div class="col-md-3 PAll ';
